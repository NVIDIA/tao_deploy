...
def instantiate_dev_docker(gpus, mount_file,
    ...
    mount_string = "-v {}:/workspace/tao-deploy ".format(os.getenv("NV_TAO_DEPLOY_TOP", os.getcwd()))

    # Defining env variables.
    env_variables = "-e PYTHONPATH={}:$PYTHONPATH ".format("/workspace/tao-deploy")
    ...
    working_directory = "/workspace/tao-deploy"
...
def main(cl_args=None):
    ...
    args = parse_cli_args(runner_args)
