...
registry="nvcr.io"
repository="nvidia/tao/tao_toolkit"

tag="5.0.0-deploy-base"
local_tag="$USER"
...
if [ $BUILD_DOCKER = "1" ]; then
    ...
    DOCKER_BUILDKIT=1 docker build --pull -f $NV_TAO_DEPLOY_TOP/docker/Dockerfile -t $registry/$repository:$local_tag $NO_CACHE \
