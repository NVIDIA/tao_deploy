...
class CalibrationConfig:
    ...
    cal_image_dir: List[str] = LIST_FIELD(
        arrList=MISSING,
        description="Path to the calibration image directory.",
        display_name="Calibration Image Directory",
    )
...
@dataclass
class CenterPoseGenTrtEngineExpConfig:
    """Gen TRT Engine experiment config."""

    results_dir: Optional[str] = STR_FIELD(
        value=None,
        default_value="<path to results dir>",
