...
from nvidia_tao_deploy.cv.centerpose.utils import rotation_y_matrix, safe_divide
import nvidia_tao_deploy.cv.centerpose.iou3d as Box
...
class Evaluator(object):
    ...
    def evaluate_2d(self, box, instance_3d, Mo2c, proj):
        ...
        for id_symmetry in range(self.eval_config.eval_num_symmetry):
            ...
            error_best = min(error_best, error)
    ...
    def write_report(self, results_dir=None):
