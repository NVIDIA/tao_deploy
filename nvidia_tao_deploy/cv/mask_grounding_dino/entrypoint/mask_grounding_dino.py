...
import argparse
from nvidia_tao_deploy.cv.mask_grounding_dino import scripts
...
def main():
    ...
    parser = argparse.ArgumentParser(
        "mask_grounding_dino",
        add_help=True,
        description="Train Adapt Optimize Deploy entrypoint for Mask Grounding DINO"
    )
    ...
    launch(vars(args), unknown_args, subtasks, network="mask_grounding_dino")
