...
"""Visual ChangeNet TensorRT engine builder."""
...
class ChangeNetEngineBuilder(EngineBuilder):
    ...
    This class is responsible for parsing an ONNX graph and constructing a
    TensorRT engine from it.

    Args:
        data_format (str): The data format for the engine, either "channels_first" or "channels_last".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize the Visual ChangeNetEngineBuilder."""
    ...
    def create_network(self, model_path, file_format="onnx"):
        ...
        if file_format == "onnx":
            ...
            raise NotImplementedError("UFF for Visual ChangeNet is not supported")
    ...
    def create_engine(self, engine_path, precision,
        ...
        if precision == "fp16":
            ...
            raise NotImplementedError("INT8 is not supported for Visual ChangeNet!")
