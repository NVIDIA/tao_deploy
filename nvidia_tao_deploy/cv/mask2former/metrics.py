...
def intersect_over_union(pred_label,
                         label,
                         num_classes,
                         ignore_index,
                         label_map={},
    ...
    Args:
        ...
        ignore_index (int or list): Index that will be ignored in evaluation.
    ...
    if isinstance(ignore_index, list):
        mask = np.ones_like(label).astype(np.bool)
...
def total_intersect_over_union(results,
                               gt_seg_maps,
                               num_classes,
                               ignore_index,
                               label_map={},
...
def eval_metrics(results,
    ...
    total_area_intersect, total_area_union, total_area_pred_label, \
        total_area_label = total_intersect_over_union(
            results, gt_seg_maps,
