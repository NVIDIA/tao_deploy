...
def main(cfg: ExperimentConfig) -> None:
    """Grounding DINO DINO TRT evaluation."""
    ...
    eval_metric = EvaluationMetric(cfg.dataset.test_data_sources.json_file,
                                   include_mask=False)
    trt_infer = GDINOInferencer(cfg.evaluate.trt_engine,
    ...
    input_ids, attention_mask, position_ids, token_type_ids, text_self_attention_masks, pos_map = tokenize_captions(tokenizer, cat_lists, captions, max_text_len)
