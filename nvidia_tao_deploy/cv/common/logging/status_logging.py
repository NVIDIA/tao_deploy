...
def set_status_logger(status_logger):
    ...
    try:
        from nvidia_tao_deploy.cv.common.logging.tlt_logging import enable_dual_logging  # pylint: disable=C0415
        enable_dual_logging()
    except Exception:
...
def get_status_logger():
    ...
    global _STATUS_LOGGER  # noqa: F824 pylint: disable=W0602,W0603
