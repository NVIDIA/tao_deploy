...
class EfficientDetInferencer(TRTInferencer):
    ...
    def __init__(self, engine_path, max_detections_per_image=100, batch_size=1, data_format="channel_last"):
        """Init.
        ...
        """
        # Load TRT engine
        super().__init__(engine_path, batch_size=batch_size, data_format=data_format)
    ...
    def infer(self, imgs, scales=None):
        ...
        # For efficientdet, there is just 1: [input_1]
