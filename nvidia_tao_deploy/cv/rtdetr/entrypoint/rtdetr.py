...
import argparse
from nvidia_tao_deploy.cv.rtdetr import scripts
...
def main():
    ...
    parser = argparse.ArgumentParser(
        "rtdetr",
        add_help=True,
        description="Train Adapt Optimize Deploy entrypoint for RT-DETR"
    )
    ...
    launch(vars(args), unknown_args, subtasks, network="rtdetr")
